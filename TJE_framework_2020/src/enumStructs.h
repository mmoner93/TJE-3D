...
#define MAX_IMPACTO_DISPAROS 1000
#define MAX_IMPACTO_DISPAROS_PEGAMENTO 1000
#define MAX_IMPACTO_DISPAROS_MOVIMIENTO 1000
#define MAX_GRANADE_IN_MOVE 100
#define MAX_DECORACION 5

#define MAX_PLAYER_LIFE_SHOP 20.0f
#define MAX_PLAYER_SHOOT_PEGAMENTO_SHOP 10
#define MAX_PLAYER_VELOCITY_SHOP 5
#define MAX_PLAYER_BALAS_SHOP 1000
#define MAX_PLAYER_PEGAMENTO_SHOP 10
#define MAX_PLAYER_GRANADE_SHOP 50
#define MAX_PLAYER_VEL_SHOP 5
...
enum estadosRobot { STOP_R, ANDAR_TONTO, ANDAR_LISTO,DESTRUIR_TORRE,E_REPAIR,STUNNED };
